    ...
    def data(self, index, role=Qt.DisplayRole):
        ...
        if role == Qt.DisplayRole or role == Qt.EditRole:
            ...
            if index.column() == 0:
                ...
                return trainTypes[index.row()].weight
            elif index.column() == 9:
                return trainTypes[index.row()].enginepower
        return None
    ...
    def setData(self, index, value, role=None):
        ...
        if role == Qt.EditRole:
            ...
            if index.column() == 1:
                ...
                self._editor.trainTypes[code].weight = value
            elif index.column() == 9:
                self._editor.trainTypes[code].enginepower = value
            else:
                return False
    ...
    def headerData(self, section, orientation, role=Qt.DisplayRole):
        ...
        if role == Qt.DisplayRole and orientation == Qt.Horizontal:
            if section == 0:
                ...
                return self.tr("Weights of the train")
            elif section == 9:
                return self.tr("Engine Power of the train")
...
class TrainType:
    ...
    def __init__(self, parameters):
        ...
        self._weight = float(parameters["weight"])
        self._enginepower = float(parameters["enginepower"])
    ...
    def stdBraking(self, value):
        ...
        if self.simulation.context == utils.Context.EDITOR_TRAINTYPES:
            #self._stdBraking = (value/10)*(value*10)
    ...
    def emergBraking(self, value):
        ...
        if self.simulation.context == utils.Context.EDITOR_TRAINTYPES:
            #self._emergBraking = 2*(value/10)*(value*10)
    ...
    def weight(self):
        """
        :return: weight of the train in tons
        :rtype: float
        """
        return self._weight
    ...
    def weight(self, value):
        """Setter function for the weight property"""
        if self.simulation.context == utils.Context.EDITOR_TRAINTYPES:
            self._weight = value
    ...
    def enginepower(self):
        """
         :return: enginepower of the train in horsepower
            :rtype: float
        """
    ...
    def enginepower(self, value):
            """Setter function for the enginepower property"""
            if self.simulation.context == utils.Context.EDITOR_TRAINTYPES:
                self._enginepower = value